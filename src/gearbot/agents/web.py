        ...
        try:
            while True:
                try:
                    ...
                    self.console.print("\n[yellow]Ctrl+C detected. Closing agent...[/yellow]")
                    break
            ...
            try:
                ...
                self.console.print(f"[dim]Error during shutdown: {e}[/dim]")
            else:
                self.console.print("[green]Browser closed correctly. Goodbye![/green]")
